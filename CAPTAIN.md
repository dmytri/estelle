...
- **Ship 0.1.2 after the batch is green**, with the operator's standing approval to commit and push: bump, build, real PTY boot eyeball, publish `--access public`, push.
