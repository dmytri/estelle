...
- Deferred hygiene: ~4 stale seat-switch `@planks` a Boatswain was mid-removing when a session-limit API error killed the cycle; and pre-existing stale planks. Not committed. Next release is `0.1.13` (crew-flow B+C) after a real-bin boot-verify.
