...
- Next: steer-asset voyage (QM on `watch1`, base `ec18cb1`), then ship 0.1.7. Harbour inventory done and clean. Boatswain flagged this file carries resolved/shipped history worth trimming to git; optional, do during a harbour lull.
